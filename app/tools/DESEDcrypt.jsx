...
export default function DESEDcrypt({route}) {
...
function Comp() {
  ...
  const encrypt = () => {
    var res = CryptoJS.DES.encrypt(input, key).toString();
    setResult(res.toString());
  };

  const decrypt = () => {
    var res = CryptoJS.DES.decrypt(input, key).toString(CryptoJS.enc.Utf8);
    setResult(res.toString());
  };
